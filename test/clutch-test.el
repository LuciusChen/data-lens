...
(ert-deftest clutch-test-completion-at-point-uses-cached-columns-for-small-statement-scope ()
  "Identifier completion should use cached columns for a small current statement."
  (with-temp-buffer
    (insert "us")
    (let ((schema (make-hash-table :test 'equal))
          (clutch-connection 'fake)
...
(ert-deftest clutch-test-completion-at-point-queues-columns-async-for-small-statement-scope ()
  "Identifier completion should queue background columns on cache miss."
  (with-temp-buffer
    (insert "us")
    (let ((schema (make-hash-table :test 'equal))
          (clutch-connection 'fake)
...
;; --- resolve-object-entry layered resolution tests ---
