...
(setq clutch-connection-alist
      '(;; Oracle (service name style)
        ...
        ;; Use :backend jdbc with a full JDBC URL.
        ("clickhouse" . (:backend jdbc
        ...
        ;; KingbaseES via JDBC
        ;; The PostgreSQL-form URL also works in many setups; use whichever
        ;; driver line your environment standardizes on.
