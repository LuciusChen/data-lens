...
ordering), schema browsing (lazy async expand), SQL keyword completion (CAPF),
REPL, MySQL/PG protocol correctness (IEEE 754 float decoding, PG type dispatch,
PBKDF2-SHA256, buffer read-offset tracking).
